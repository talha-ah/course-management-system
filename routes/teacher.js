...
router.get(
  ...
  isAuth,
  teacherController.completeCourse
);
...
router.delete(
  "/deletecourselog/:logDocId/:logId",
  isAuth,
  teacherController.deleteCourseLog
);
...
router.delete(
  "/deleteassignment/:assignmentDocId/:assignmentId",
  isAuth,
...
router.delete(
  "/deletepaper/:paperDocId/:paperId",
  isAuth,
